"""
main.py
FastAPI application entry point. Run from backend/ with:
...
# Allows the React development server (running on a different port) to call this API.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # restrict this to your deployed React URL in production
