...
class Task(Base):
    ...
    deadline = Column(Date, nullable=True)
    # Optional role/designation required to take ownership of this task.
    # Kept for compatibility with existing production task assignments.
    required_designation = Column(String(100), nullable=True, index=True)
